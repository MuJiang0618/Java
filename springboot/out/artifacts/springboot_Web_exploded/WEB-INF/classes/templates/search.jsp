...
<div style="position: absolute; left: 550px; height: 100px">
    <ul style="position: absolute; top: 180px; width: 1000px;">
        <c:forEach items="${resBlog}" var="blog" varStatus="st">
            <li>
                <tr>
                    <td>
                        ${blog.author_name}
        ...
        <tr>
            <td colspan="6" align="center">
                <a href="?start=0&query=${rawQuery}">[首  页]</a>
                <a href="?start=${page.pre}&query=${rawQuery}">[上一页]</a>
                <a href="?start=${page.next}&query=${rawQuery}">[下一页]</a>
                <a href="?start=${page.last}&query=${rawQuery}">[末  页]</a>
            </td>
        </tr>
